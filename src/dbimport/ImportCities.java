 ...
 *
 */
public class ImportCities extends Database {
	...
	public ImportCities(PApplet p, String fileName) {
		super();

		try {
			
			List<Feature> cities = GeoJSONReader.loadData(p, fileName);


			for (Feature city : cities) {

				String entry_name = (String) city.getProperty("name");
				String entry_population = (String) city
						.getProperty("population");
				String entry_country = (String) city.getProperty("country");
				String entry_coastal = (String) city.getProperty("coastal");
				CityMarker city_m = new CityMarker(city);
